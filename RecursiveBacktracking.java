package com.example.recursivebacktracking;
...
public class RecursiveBacktracking extends Application {

    // Game configuration variables
    private static final int HEIGHT = 51; // Must be odd for maze generation
    private static final int WIDTH = 51;  // Must be odd for maze generation
    ...
    // Maze class using the Recursive Backtracker algorithm
    class Maze {
    ...
    abstract class Enemy {
        ...
        // Instead of reset, provide a method that encapsulates reset behavior
